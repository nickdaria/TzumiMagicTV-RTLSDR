...
TCP_PORT = 6000
BUFFER_SIZE = 1024
CHOICE = input("Enter channel number: ")
...
MESSAGE2 = '<msg type="tune_req"><params tv_type="ATSC" freq="' + str(CHANNEL) +'000" bandwidth="8000" plp="0" programNumber="' + str(SUBCHANNEL) +'"/></msg>'
