...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C00302 extends AccessibilityDelegateCompat {
        C00302() {
        }
    ...
    class C00313 extends BottomSheetCallback {
        C00313() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int i) {
        ...
        this.mBottomSheetCallback = new C00313();
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        return context.getTheme().resolveAttribute(C0003R.attr.bottomSheetDialogTheme, typedValue, true) ? typedValue.resourceId : C0003R.style.Theme_Design_Light_BottomSheetDialog;
    }

    private View wrapInBottomSheet(int i, View view, LayoutParams layoutParams) {
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) View.inflate(getContext(), C0003R.layout.design_bottom_sheet_dialog, null);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout = (FrameLayout) coordinatorLayout.findViewById(C0003R.id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C0003R.id.touch_outside).setOnClickListener(new C00291());
        ViewCompat.setAccessibilityDelegate(frameLayout, new C00302());
