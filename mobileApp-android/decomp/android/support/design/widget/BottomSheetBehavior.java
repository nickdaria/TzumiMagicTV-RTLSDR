...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new C00272();
    boolean mHideable;
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        if (peekValue == null || peekValue.data != -1) {
            setPeekHeight(obtainStyledAttributes.getDimensionPixelSize(C0003R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        } else {
