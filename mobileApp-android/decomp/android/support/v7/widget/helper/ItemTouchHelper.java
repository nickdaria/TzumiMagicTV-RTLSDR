...
import android.support.v7.recyclerview.C0276R;
...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C03662();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C03651();
    ...
    class C03662 implements OnItemTouchListener {
        C03662() {
        }
    ...
    class C03695 implements ChildDrawingOrderCallback {
        C03695() {
        }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C03701();
        private static final Interpolator sDragViewScrollCapInterpolator = new C03712();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        static class C03701 implements Interpolator {
            C03701() {
            }
        ...
        static class C03712 implements Interpolator {
            C03712() {
            }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C03695();
            }
        ...
        if (viewHolder != this.mSelected || i != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (viewHolder2.itemView.getParent() != null) {
                    ...
                    RecoverAnimation c03673 = new RecoverAnimation(viewHolder2, i4, i2, f2, f3, f, signum) {
                        public void onAnimationEnd(ValueAnimatorCompat valueAnimatorCompat) {
                    ...
                    c03673.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, i4, f - f2, signum - f3));
                    this.mRecoverAnimations.add(c03673);
                    c03673.start();
                    obj = 1;
                } else {
