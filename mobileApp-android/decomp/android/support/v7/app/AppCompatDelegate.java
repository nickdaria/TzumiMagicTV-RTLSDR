...
public abstract class AppCompatDelegate {
    ...
    private static AppCompatDelegate create(Context context, Window window, AppCompatCallback appCompatCallback) {
        ...
        return BuildCompat.isAtLeastN() ? new AppCompatDelegateImplN(context, window, appCompatCallback) : i >= 23 ? new AppCompatDelegateImplV23(context, window, appCompatCallback) : i >= 14 ? new AppCompatDelegateImplV14(context, window, appCompatCallback) : i >= 11 ? new AppCompatDelegateImplV11(context, window, appCompatCallback) : new AppCompatDelegateImplV9(context, window, appCompatCallback);
    }
