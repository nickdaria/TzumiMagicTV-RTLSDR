...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02711();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02722();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02733();

    class C02711 extends ViewPropertyAnimatorListenerAdapter {
        C02711() {
        }
    ...
    class C02722 extends ViewPropertyAnimatorListenerAdapter {
        C02722() {
        }
    ...
    class C02733 implements ViewPropertyAnimatorUpdateListener {
        C02733() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0274R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0274R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0274R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0274R.id.action_bar_container);
        ...
        if (obtainStyledAttributes.getBoolean(C0274R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0274R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0274R.attr.actionBarWidgetTheme, typedValue, true);
