...
final class StandardMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnItemClickListener, OnDismissListener {
    ...
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C02911();
    ...
    class C02911 implements OnGlobalLayoutListener {
        C02911() {
        }
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i, int i2, boolean z) {
        ...
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0274R.dimen.abc_config_prefDialogWidth));
    ...
    private boolean tryShow() {
        ...
        if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(C0274R.layout.abc_popup_menu_header_item_layout, listView, false);
