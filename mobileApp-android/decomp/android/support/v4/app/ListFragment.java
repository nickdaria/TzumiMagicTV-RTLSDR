...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01122();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01111();
    ...
    class C01122 implements OnItemClickListener {
        C01122() {
        }
