...
public class TransportMediator extends TransportController {
    ...
    class C01571 implements TransportMediatorCallback {
        C01571() {
        }
    ...
    class C01582 implements Callback {
        C01582() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new C01571();
        this.mKeyEventCallback = new C01582();
