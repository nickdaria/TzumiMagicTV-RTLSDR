...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01791();
    ...
    static class C01791 implements Creator<PlaybackStateCompat> {
        C01791() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01801();
        ...
        static class C01801 implements Creator<CustomAction> {
            C01801() {
            }
