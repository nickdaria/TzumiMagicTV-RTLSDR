...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Callback mCallback = new C02303();
    boolean mFinishing;
    ...
    class C02303 implements Callback {
        C02303() {
        }
    ...
    private void setupAnimators() {
        ...
        Animation c02281 = new Animation() {
        ...
        c02281.setRepeatCount(-1);
        c02281.setRepeatMode(1);
        c02281.setInterpolator(LINEAR_INTERPOLATOR);
        c02281.setAnimationListener(new AnimationListener() {
