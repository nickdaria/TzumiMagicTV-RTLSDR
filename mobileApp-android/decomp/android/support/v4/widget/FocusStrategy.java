...
class FocusStrategy {
        ...
        public int compare(T t, T t2) {
            ...
            if (rect.left < rect2.left) {
                ...
                if (rect.right >= rect2.right) {
                    return rect.right > rect2.right ? !this.mIsLayoutRtl ? 1 : -1 : 0;
                } else {
                    if (!this.mIsLayoutRtl) {
                        i = -1;
                    }
    ...
    private static boolean isBetterCandidate(int i, @NonNull Rect rect, @NonNull Rect rect2, @NonNull Rect rect3) {
        return !isCandidate(rect, rect2, i) ? false : (!isCandidate(rect, rect3, i) || beamBeats(i, rect, rect2, rect3)) ? true : beamBeats(i, rect, rect3, rect2) ? false : getWeightedDistanceFor(majorAxisDistance(i, rect, rect2), minorAxisDistance(i, rect, rect2)) < getWeightedDistanceFor(majorAxisDistance(i, rect, rect3), minorAxisDistance(i, rect, rect3));
    }
