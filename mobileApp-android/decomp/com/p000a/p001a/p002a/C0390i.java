...
public class C0390i extends C0383d {
    public C0390i(C0387f c0387f, C0381b c0381b, int i) throws IOException {
        ByteBuffer allocate = ByteBuffer.allocate(4);
        allocate.order(c0381b.f16a ? ByteOrder.BIG_ENDIAN : ByteOrder.LITTLE_ENDIAN);
        this.a = c0387f.m30c(allocate, (c0381b.f19d + ((long) (c0381b.f22g * i))) + 28);
    }
}
